...
import { PlasmaEngine } from "@/lib/animations/PlasmaEngine";
import type { PlasmaConfig } from "@/lib/types/animation";
...
export function PlasmaBackground({ config, className = "" }: PlasmaBackgroundProps) {
