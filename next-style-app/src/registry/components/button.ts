...
export const buttonRegistryItem: ComponentRegistryItem = {
  meta: createComponentMeta({
    ...
    relatedComponents: ['link-button', 'icon-button'],
  }),
  files: [
    {
      path: 'components/ui/button.tsx',
      type: 'component',
      content: '', // Will be populated during build
...
export function ButtonSizes() {
  ...
  installCommand: 'npx @/cli add button',
